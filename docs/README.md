...
2. **[راهنمای سریع](./01-getting-started/quickstart.md)** - ساخت اولین API در 10 دقیقه
3. **[ساختار پروژه](./01-getting-started/project-structure.md)** - آشنایی با ساختار
4. **[CLI Commands](../CLI.md)** - یادگیری دستورات CLI
